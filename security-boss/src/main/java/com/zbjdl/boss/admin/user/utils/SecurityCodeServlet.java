...
public class SecurityCodeServlet extends HttpServlet {
	 ...
	 * @throws IOException
	 */
	public void generateSecurityCode(HttpServletRequest request,
...
//		encoder.encode(image);
	...
	private BufferedImage drawSecurityCode(int width, int height) {
		...
		for (int i = 0; i < 4; i++) {
			...
			graph.setColor(new Color(20 + rand.nextInt(110), 20 + rand
	...
	private String getRandomChar() {
		...
		case 1:
			return String.valueOf((char) (CAPITAL_ASCII_INDEX + random
					.nextInt(RANGE_LETTER)));
		case 2:
			return String.valueOf((char) (LOWER_ASCII_INDEX + random
					.nextInt(RANGE_LETTER)));
		default:
			return String.valueOf((char) (INTEGER_ASCII_INDEX + random
					.nextInt(RANGE_INTEGER)));
		}
	}
