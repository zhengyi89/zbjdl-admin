      ...
      <div class="result">
        <div class="information">
          ...
          <div class="input_cont">
            <form action="${ctxPath}/template/addTemplate.action" id="form" method="post">
              <ul>
                <li>
                ...
                <li>
                  ...
                  <textarea  class="textfield" name="content" id="content" value=""></textarea>
                </li>
                <li>
                  <label class="text_tit">&nbsp;</label>
                  <input type="button" id="changeBtn" class="btn_sure fw" value="新增" onclick="change();" style="display:none">
