...
function activeButton(){
  ...
  <body class="darkBg">
    <div id="content_1" class="form_outer">
      <form class="form_size" action="login" method="post" onsubmit="return formValidate()">
        <input type="hidden" id="isShowCode" name="isShowCode" value="<s:property value="isShowCode" />" />
        <input type="hidden" id="returnUrl" name="returnUrl" value="<s:property value="returnUrl" />" />
        ...
        <div class="form_content">
          ...
          <span id="errorMessage" style="color:red"><s:actionmessage/></span>
            <div class="input_content">
              ...
              <input  title="required"  id="loginName" name="loginName" type="text" class="input_self" placeholder="" value="<s:property value="loginName" escape="true" />"/>
        ...
        <s:if test="isShowCode == 'true'">
            <div class="input_content_s">
              ...
              <a href="javascript:void(0);" onclick="refreshCode();"><img id="securityCode" width="75px" height="25px" src="../Kaptcha.jpg"/></a>
              <p class="input_error"></p>
            </div>
        </s:if>
          </div>
