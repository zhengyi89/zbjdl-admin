...
import com.zbjdl.boss.admin.frame.tag.component.AuthorityIfComponent;
 ...
 *     
 */
public class AuthorityIfTag extends ComponentTagSupport {
	...
	public Component getBean(ValueStack arg0, HttpServletRequest arg1, HttpServletResponse arg2) {
		return new AuthorityIfComponent(arg0);
	}
	...
	protected void populateParams() {
		((AuthorityIfComponent) super.getComponent()).setUrl(url);
	}
