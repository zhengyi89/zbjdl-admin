...
public interface SecurityConfigFacade {
	 ...
	 *
	 * @author feng
	 * @since 2013-06-27 15:44:05
	 *
	 * @param departmentId    待迁移部门 Id
	 * @param newDepartmentId 拟迁移到部门 Id
	 * @param migrateUser     是否迁移用户
	 * @param migrateRole     是否迁移角色
	 * @param migrateFunction 是否迁移功能
	 */
