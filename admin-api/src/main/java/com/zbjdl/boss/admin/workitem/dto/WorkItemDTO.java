 ...
 * 
 * @author：feng
 * @since：2011-11-17 下午01:56:37
 * @version:
 * 
 */
public class WorkItemDTO extends BaseDTO {

	private static final long serialVersionUID = -1121845518197556376L;
	...
	public Object getValue(String key) {
		if (contentMap == null && StringUtils.isNotBlank(content)) {
			try {
				contentMap = JSONUtils.jsonToMap(content, String.class, null);
			} catch (Exception e) {
			}
		}
		if (contentMap == null) {
